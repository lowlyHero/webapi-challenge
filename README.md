...
-- There are 3 types of middleware: Built-In, Third-Party, and Custom made. One of the biggest parts of Express.

- [ ] Describe a Resource?

-- Managed by endpoints that are published with the server software
